...
<body class="h-100">
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{asset('dahsboard_assets/vendor/global/global.min.js')}}"></script>
	<script src="{{asset('dahsboard_assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
    <script src="{{asset('dahsboard_assets/js/custom.min.js')}}"></script>
    <script src="{{asset('dahsboard_assets/js/deznav-init.js')}}"></script>
